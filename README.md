...
<ul>
<li><strong>Gitflow</strong>: Metodología de control de versiones basado en branches especificas.</li>
<li><strong>Virutal Environment</strong>: Instalación de las dependencias de la aplicación en un entorno aislado, durante la fase de desarrollo.</li>
